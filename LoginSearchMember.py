...
class LoginSearch(unittest.TestCase):
    def setUp(self):
    ...
    def test_login_search(self):
        ...
        driver.find_element_by_css_selector("input[type=\"text\"]").send_keys("greenberg")
        ...
        for i in range(10):
            try:
                if self.is_element_present(By.LINK_TEXT, "Rachel Greenberg"): break
            except: pass
            time.sleep(1)
