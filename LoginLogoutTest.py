...
class LoginLogoutTest(unittest.TestCase):
    ...
    def test_login_logout(self):
        ...
        for i in range(60):
            try:
                if self.is_element_present(By.ID, "aside"): break
            except: pass
            time.sleep(1)
        ...
        try: self.assertTrue(self.is_element_present(By.ID, "password"))
        except AssertionError as e: self.verificationErrors.append(str(e))
        try: self.assertTrue(self.is_element_present(By.XPATH, "//input[@value='Login']"))
        except AssertionError as e: self.verificationErrors.append(str(e))
